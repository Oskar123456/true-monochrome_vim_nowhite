...
"" black fg w/white bg
hi Cursor          guifg=#000000    guibg=#CCCCCC    ctermfg=black    ctermbg=white    gui=NONE         cterm=NONE
hi IncSearch       guifg=#000000    guibg=#CCCCCC    ctermfg=black    ctermbg=white    gui=ITALIC       cterm=NONE
hi Search          guifg=#000000    guibg=#CCCCCC    ctermfg=black    ctermbg=white    gui=ITALIC       cterm=NONE
hi Visual          guifg=#000000    guibg=#CCCCCC    ctermfg=black    ctermbg=white    gui=ITALIC       cterm=NONE
hi VisualNOS       guifg=#000000    guibg=#CCCCCC    ctermfg=black    ctermbg=white    gui=ITALIC       cterm=NONE

"" grey fg w/white bg
hi CursorColumn    guifg=#A0A0A0    guibg=#CCCCCC    ctermfg=grey     ctermbg=white    gui=NONE         cterm=NONE
hi CursorLine      guifg=#A0A0A0    guibg=#CCCCCC    ctermfg=grey     ctermbg=white    gui=NONE         cterm=NONE
...
hi MatchParen      guifg=#DDDDDD    guibg=#000000    ctermfg=grey     ctermbg=black    gui=NONE         cterm=NONE
hi MatchParen      guifg=#DDDDDD    guibg=#000000    ctermfg=grey     ctermbg=black    gui=UNDERLINE    cterm=UNDERLINE
...
"" white fg w/black bg
hi Comment         guifg=#5A5A5A    guibg=#000000    ctermfg=7    ctermbg=black    gui=ITALIC       cterm=NONE
hi Constant        guifg=#5A5A5A    guibg=#000000    ctermfg=7    ctermbg=black    gui=NONE         cterm=NONE
hi DiffAdd         guifg=#5A5A5A    guibg=#000000    ctermfg=7    ctermbg=black    gui=NONE         cterm=NONE
hi Number          guifg=#5A5A5A    guibg=#000000    ctermfg=7    ctermbg=black    gui=NONE         cterm=NONE
hi Pmenu           guifg=#5A5A5A    guibg=#000000    ctermfg=7    ctermbg=black    gui=BOLD         cterm=BOLD
hi String          guifg=#5A5A5A    guibg=#000000    ctermfg=7    ctermbg=black    gui=NONE         cterm=NONE
